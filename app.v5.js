...
async function pickModel(key){
  const prefs=['gemini-2.5-flash','gemini-2.5-flash-lite','gemini-2.0-flash','gemini-2.0-flash-lite','gemini-flash-latest','gemini-1.5-flash','gemini-2.5-pro','gemini-2.0-pro'];
  try{
  ...
  return 'gemini-2.5-flash'; // last-resort default
}
